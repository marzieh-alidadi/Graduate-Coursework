...
function text_0RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of text_0Components)
...
function estimation_trialsLoopBegin(estimation_trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisEstimation_trial of estimation_trials) {
...
function fixation_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixation_trainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_trainingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_trainingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function text_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of text_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fixation_learningRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixation_learningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_learningRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_learningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fixation_transferRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixation_transferComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_transferRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_transferComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function slider_transferRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of slider_transferComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function text_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of text_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function fixation_estimationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixation_estimationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function main_estimationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of main_estimationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function show_rewardRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of show_rewardComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
