...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\UT\\semester 4 - courses\\Cognitive science\\HWs\\HW1\\answer\\article1\\article1_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    training_trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    # completed 5.0 repeats of 'training_trials'
    ...
    # keep track of which components have finished
    show_rewardComponents = [text4, totalRewardText, text4_key_resp]
    ...
    while continueRoutine:
        ...
        if text4_key_resp.status == STARTED and not waitOnFlip:
            theseKeys = text4_key_resp.getKeys(keyList=None, ignoreKeys=["escape"], waitRelease=False)
